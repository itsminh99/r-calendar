...
var Calendar = /*#__PURE__*/function (_PureComponent) {
  ...
  function Calendar(_props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onDragSelectionStart", function (date) {
      var currentDate = _this.props.date;

      if (currentDate) {
        date = (0, _setHours.default)(date, (0, _getHours.default)(currentDate));
        date = (0, _setMinutes.default)(date, (0, _getMinutes.default)(currentDate));
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "onChangeTime", function (value, unit) {
      var _this$props5, _this$state$preview;

      if (!((_this$props5 = _this.props) !== null && _this$props5 !== void 0 && _this$props5.date) || !((_this$state$preview = _this.state.preview) !== null && _this$state$preview !== void 0 && _this$state$preview.startDate)) return;
      var newDate, newPreviewDate;

      if (unit === 'hour') {
        newDate = (0, _setHours.default)(_this.props.date, value);
        newPreviewDate = (0, _setHours.default)(_this.state.preview.startDate, value);
      } else {
        newDate = (0, _setMinutes.default)(_this.props.date, value);
        newPreviewDate = (0, _setMinutes.default)(_this.state.preview.startDate, value);
      }

      _this.updatePreview(newPreviewDate);

      _this.props.onChange && _this.props.onChange(newDate);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "onDragSelectionEnd", function (date) {
      ...
      var _this$props6 = _this.props,
          updateRange = _this$props6.updateRange,
          displayMode = _this$props6.displayMode,
          onChange = _this$props6.onChange,
          dragSelectionEnabled = _this$props6.dragSelectionEnabled;
  ...
  _createClass(Calendar, [{
    ...
    value: function render() {
      ...
      var _this$props8 = this.props,
          showDateDisplay = _this$props8.showDateDisplay,
          onPreviewChange = _this$props8.onPreviewChange,
          scroll = _this$props8.scroll,
          direction = _this$props8.direction,
          disabledDates = _this$props8.disabledDates,
          disabledDay = _this$props8.disabledDay,
          maxDate = _this$props8.maxDate,
          minDate = _this$props8.minDate,
          rangeColors = _this$props8.rangeColors,
          color = _this$props8.color,
          navigatorRenderer = _this$props8.navigatorRenderer,
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        return /*#__PURE__*/_react.default.createElement(_Month.default, _extends({}, _this5.props, {
          date: (_this5$props = _this5.props) !== null && _this5$props !== void 0 && _this5$props.date ? new Date(_this5.props.date) : undefined,
          onPreviewChange: onPreviewChange || _this5.updatePreview,
          preview: preview || _this5.state.preview,
          ranges: ranges,
          key: i,
          ...
          onChangeTime: _this5.onChangeTime
        }));
      })));
    }
  }]);
...
Calendar.propTypes = {
  ...
  hasTime: _propTypes.default.bool
};

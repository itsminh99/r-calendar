...
var _TimeContent = _interopRequireDefault(require("./TimeContent"));
...
var TimePicker = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(TimePicker, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/_react.default.createElement(_TimeContent.default, {
        value: (0, _getHours.default)(date),
        max: 23,
        update: this.props.onChangeTime,
        unit: "hour"
      }), /*#__PURE__*/_react.default.createElement(_TimeContent.default, {
        value: (0, _getMinutes.default)(date),
        max: 59,
        update: this.props.onChangeTime,
        unit: "minute"
      }));
...
TimePicker.propTypes = {
  ...
  onChangeTime: _propTypes.default.func.isRequired
};
